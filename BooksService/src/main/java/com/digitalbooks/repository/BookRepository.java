...
//			String publisher);
	...
	boolean existsByAuthorIdAndBookId(String authorId,Long bookId );
	
	 List<BookVo> findByAuthorId(String authorId);
	 List<BookVo> findByAuthorIdAndBookId(String authorId,Long bookId);
}
