...
public class BookController {
	...
	public ResponseEntity<BookVo> createBook(@RequestBody BookVo book,@PathVariable String authorId) throws BookServiceExceptionHandler{
		...
		try {
			...
			throw new BookServiceExceptionHandler("insertUserData()--->",e);
		}
	}

	@PostMapping(value="/author/{authorId}/books/{bookId}")
	public ResponseEntity<BookVo> updateBook(@RequestBody BookVo book,@PathVariable String authorId,@PathVariable String bookId) throws BookServiceExceptionHandler{
	...
	@GetMapping("/search")
	public ResponseEntity<List<BookVo>> searchBooksNew(@RequestParam(name="category" ,defaultValue="") String category,@RequestParam(name="title",defaultValue="") String title,@RequestParam(name="author",defaultValue="") String author,@RequestParam(name="price",defaultValue="0") String price,@RequestParam(name="publisher",defaultValue="") String publisher ) throws BookServiceExceptionHandler{
	...
	public  ResponseEntity<String> subscribeBook(@RequestBody ReaderVo reader,  @PathVariable String bookId) throws BookServiceExceptionHandler{
		try {
	...
	public ResponseEntity<List<BookVo>> getAllSubscribeBooksByReader(@PathVariable String emailId) throws BookServiceExceptionHandler{
	...
	public ResponseEntity<BookVo> getSubscribeBookByReaderEmailId(@PathVariable String emailId,@PathVariable String subscriptionId) throws BookServiceExceptionHandler{
		if(emailId!=null&&!emailId.equalsIgnoreCase("")) {
			try {
	...
	public ResponseEntity<String> getSubscribeBookContentByReaderEmailId(@PathVariable String emailId,@PathVariable String subscriptionId) throws BookServiceExceptionHandler{
		if(emailId!=null&&!emailId.equalsIgnoreCase("")) {
			try {
			BookVo subscribBookByReader=bookService.getSubscribeBookByReader(emailId,subscriptionId);
	...
	public ResponseEntity<String>cancleSubscriptionWithIn24Hours(@PathVariable String readerId,@PathVariable String subscriptionId ) throws BookServiceExceptionHandler{
	...
	public ResponseEntity<String> blockOrUnBlockBookByAuthor(@PathVariable(value="authorId") String authorId,@PathVariable(value="bookId") String bookId,@PathVariable(value="block") String block) throws BookServiceExceptionHandler{
